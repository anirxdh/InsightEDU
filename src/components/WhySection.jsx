  ...
  <section className="why-section">
    ...
    <div className="why-grid">
      ...
      <div className="why-content">
        <p>
          Build a privacy-respecting, interactive 3D data website that showcases educational equity insights in our district through charts, dashboards, and an AI assistant.
        </p>
        <p>
